...
print """Enter the optional arguments. Leave blank if you do not want
...
duplicates = raw_input("""Do you want duplicate scan results for hosts? 
						(yes/no) """) == 'yes'
email_choice = raw_input("""Do you want the results to be emailed? 
							(yes/no) """) == 'yes'
columns = raw_input("""What columns would you like to be filtered in? (IP, DNS, 
						Repository, MAC, L_SEEN)""")
